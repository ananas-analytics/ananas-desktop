...
DROP TABLE IF EXISTS tableWithAllTypes;

CREATE TABLE tableWithAllTypes(
 column_serial        SERIAL UNIQUE,
 column_boolean       BOOL,
 column_tiny          TINYINT,
 column_short         SMALLINT,
 column_medium        MEDIUMINT,
 column_integer       INTEGER,
 column_int           INT,
 column_long          BIGINT,
 column_float         FLOAT,
 column_double        DOUBLE,
 column_double_p      DOUBLE PRECISION,
 column_bigdecimal    DECIMAL(13,0),
 column_string        VARCHAR(254),
 ...
 column_char          CHAR,
 column_varchar       VARCHAR(50),
 column_binary        BINARY(3),
