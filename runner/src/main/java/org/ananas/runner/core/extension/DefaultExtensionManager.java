...
public class DefaultExtensionManager implements ExtensionManager {
  ...
  private static DefaultExtensionManager INSTANCE = null;
  ...
  public DefaultExtensionManager() {
    repository = new LocalExtensionRepository(HomeManager.getHomeFilePath(EXTENSION_FOLDER));
    reset();
  }
   ...
   * @return
   */
  public static DefaultExtensionManager getDefault() {
    if (INSTANCE == null) {
      INSTANCE = new DefaultExtensionManager();
    }
    return INSTANCE;
  }
