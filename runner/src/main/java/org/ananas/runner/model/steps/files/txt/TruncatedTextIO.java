...
public class TruncatedTextIO {
	...
	public abstract static class Read extends PTransform<PBegin, PCollection<String>> {
		...
		abstract static class Builder {
			...
			abstract TruncatedTextIO.Read.Builder setMatchConfiguration(FileIO.MatchConfiguration matchConfiguration);
		...
		public PCollection<String> expand(PBegin input) {
			checkNotNull(getFilepattern(), "need to set the filepattern of a TruncatedTextIO.Read transform");
		...
		protected FileBasedSource<String> getSource() {
			return TruncatedCompressedSource.from(new TruncatedTextSource(
					getFilepattern(),
