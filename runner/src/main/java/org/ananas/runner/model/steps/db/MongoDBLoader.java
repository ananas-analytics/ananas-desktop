...
public class MongoDBLoader extends AbstractStepLoader implements StepRunner, Serializable {
	...
	public MongoDBLoader(String stepId,
						 String uri,
						 String database,
						 String collection,
						 StepRunner previous,
		...
		previous.getOutput().apply(AsBsons.of()).apply(org.apache.beam.sdk.io.mongodb.MongoDbIO.<Row>write()
				.withUri(uri)
	 ...
	 */
	public static void migrateTable(boolean overwrite,
									String tablename,
									JDBCDriver driver,
									String url,
									String username,
