...
public abstract class ClassificationHook extends MLHookTemplate {
	...
	public ClassificationHook(String mode,
							  Pipeline pipeline,
	...
	protected MutableTriple<Schema, Iterable<Row>, String> train(AttributeDataset dataset) {
		...
		MutableQuadruple<Schema, Iterable<Row>, String, Classifier<double[]>>
	 ...
	 * @return the list of clusters
	 */
	protected abstract MutableQuadruple<Schema, Iterable<Row>, String, Classifier<double[]>> trainTemplate(Attribute[] attributes,
																										   double[][] x,
																										   int[] y);
