...
public abstract class ClusteringHook extends MLHookTemplate {
	...
	public ClusteringHook(String mode,
						  Pipeline pipeline,
		...
		switch (this.mode) {
			...
			case "test":
				throw new IllegalStateException(
						"Cannot test an unsupervised algorithm. You can predict with your trained model directly.");
			default:
				throw new IllegalStateException(
	...
	/**
	 * Run train dataset , train model with supervisation , serialize model and eventually return clusters.
	 *
	 * @param dataset
