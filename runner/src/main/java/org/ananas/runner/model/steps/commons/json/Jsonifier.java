...
/**
 * This translates a Row into a serializable object.
 * Indeed, the Schema in Row object might a circular reference.
 */
public class Jsonifier implements Serializable {
	...
	/**
	 * Object value of af a field. If the field is a row we extract its fields as an array of object value.
	 *
	 * @param fieldValue any field value ( might Row, ArrayList or Primitive)
	 * @return the serializable value of a field
	 */
