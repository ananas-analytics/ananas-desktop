package org.ananas.runner.model.steps.db.jdbc.pgsql;

import org.ananas.runner.model.steps.db.jdbc.DDL;
...
public enum PostgresqlDataTypes implements JDBCDataType, DDL {
	...
	CHARVAR("character varying", Schema.FieldType.STRING, true),
	...
	TIMESTAMP_WITHOUT_TS_metadata("timestamp without time zone", Schema.FieldType.DATETIME.withMetadata("TS"), true),
	TIMESTAMP_WITH_TIME_ZONE_metadata("timestamp with time zone",
			Schema.FieldType.DATETIME.withMetadata("TS_WITH_LOCAL_TZ"), true),
	TIMESTAMPZ_metadata("timestamptz", Schema.FieldType.DATETIME.withMetadata("TS_WITH_LOCAL_TZ"), false),
	...
	NVARCHAR("nvarchar", Schema.FieldType.STRING, true),
	OBJECT("object", Schema.FieldType.STRING, true),
	...
	TIMESTAMP("timestamp", Schema.FieldType.DATETIME.withMetadata("TS"), true),
	...
	private final static Map<String, Schema.FieldType> dataTypes;
