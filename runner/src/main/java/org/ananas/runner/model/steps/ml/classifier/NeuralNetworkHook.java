...
public class NeuralNetworkHook extends ClassificationHook {
	...
	public NeuralNetworkHook(String mode,
							 Pipeline pipeline,
	...
	protected MutableQuadruple<Schema, Iterable<Row>, String, Classifier<double[]>> trainTemplate(Attribute[] attributes,
		...
		String activationFunction =
				(String) this.mlStep.config.getOrDefault(
		...
		NeuralNetwork model =
				new NeuralNetwork(NeuralNetwork.ErrorFunction.LEAST_MEAN_SQUARES,
		...
		Schema schema = Schema.builder()
				...
				.addNullableField("description", Schema.FieldType.STRING).build();
