...
public class RegressionWrapper<T extends Regression<double[]>> implements Predictor<Double>, Serializable {
	...
	public static <U extends Regression<double[]>> RegressionWrapper of(U s, FeatureTransform standardizer) {
