...
/**
 * Standardizes numeric feature to 0 mean and unit variance. Standardization makes an assumption
 * that the data follows a Gaussian distribution and are also not robust when outliers present. A
 * robust alternative is to subtract the median and divide by the IQR by <code>RobustStandardizer
 * </code>.
 *
 * @author Haifeng Li
 */
