...
public class TextConnector extends AbstractStepRunner implements StepRunner, Serializable {
	...
	public TextConnector(String stepId, String url, Pipeline pipeline, boolean doSampling, boolean isTest) {
		...
		this.output = Sampler.sample(p, 1000, (doSampling || isTest)).apply(new TextReader(schema, this.errors));
