...
public class MockPipelineApiClient {
	...
	public Pipeline getPipeline(String id) {
		...
		config.put(StepConfig.PATH, "/home/grego/go/src/github.com/bhou/bravetroops/api/tests/score.csv");
		...
		SQLconfig.put(StepConfig.SQL, "SELECT max(score) as meilleurnote, min(score) as pirenote FROM PCOLLECTION");
