...
public class CliCommands {
	...
	protected static void initCommandLine(String[] args) {
		...
		Option action = new Option("test", false,
		...
		Option optionProfiles =
				new Option("p", "profile_file", true, "use given profile file. Variables are defined in this file.");
	...
	private static <T> T openYAML(String path, Class<T> clazz) throws IOException {
		...
		ObjectMapper yamlReader = new ObjectMapper(new com.fasterxml.jackson.dataformat.yaml.YAMLFactory());
