...
public class HttpClient {
	...
	public static <T> T handle(URL url,
							   Map<String, String> params,
							   String method,
							   Object body,
							   RequestHandler<T> handler) throws IOException {
		...
		try {
			...
			if (conn.getResponseCode() != 200) {
				throw new RuntimeException(
						"Cannot connect to " + url + " \nHTTP  " + method + " " + conn.getResponseCode() + " Msg : " +
	...
	public static <T> T PUT(String uri,
							Map<String, String> params,
							Object body,
							RequestHandler<T> handler) throws IOException {
		URL url = new URL(uri);
	...
	public static <T> T GET(String uri, Map<String, String> params, RequestHandler<T> handler) throws IOException {
		URL url = new URL(uri);
